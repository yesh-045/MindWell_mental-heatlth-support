  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-80 z-50">
      <div className="bg-white rounded-lg shadow-2xl max-w-md w-full relative">
        ...
        <div className="p-6">
          <h2 className="text-3xl font-bold text-gray-800 text-center mb-6">Mental Health Chat</h2>
          <div className="bg-gray-100 rounded-lg shadow-inner p-4 h-80 overflow-y-auto mb-4">
          ...
          <div className="flex items-center">
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm-1-7V9a1 1 0 112 0v2a1 1 0 11-2 0zm-1-4a1 1 0 112 0v1a1 1 0 11-2 0V7z" clipRule="evenodd" />
              </svg>
            </button>
          </div>
        </div>
